...
public abstract class TGNoteEffect {
	...
	public boolean hasAnyEffect() {
		return (isBend() || isTremoloBar() || isHarmonic() || isGrace()
				|| isTrill() || isTremoloPicking() || isVibrato()
				|| isDeadNote() || isSlide() || isHammer() || isGhostNote()
				|| isAccentuatedNote() || isHeavyAccentuatedNote()
				|| isPalmMute() || isStaccato() || isTapping() || isSlapping()
				|| isPopping() || isFadeIn());
	}
	...
	public TGNoteEffect clone(TGFactory factory) {
		...
		effect.setBend(isBend() ? (TGEffectBend) this.bend.clone(factory)
				: null);
		...
		effect.setTrill(isTrill() ? (TGEffectTrill) this.trill.clone(factory)
				: null);
		effect.setTremoloPicking(isTremoloPicking() ? (TGEffectTremoloPicking) this.tremoloPicking
				.clone(factory) : null);
		return effect;
	}
	...
	public String toString() {
		return "TGNoteEffect [bend=" + bend + ", tremoloBar=" + tremoloBar
				+ ", harmonic=" + harmonic + ", grace=" + grace + ", trill="
				+ trill + ", tremoloPicking=" + tremoloPicking + ", vibrato="
				+ vibrato + ", deadNote=" + deadNote + ", slide=" + slide
				+ ", hammer=" + hammer + ", ghostNote=" + ghostNote
				+ ", accentuatedNote=" + accentuatedNote
				+ ", heavyAccentuatedNote=" + heavyAccentuatedNote
				+ ", palmMute=" + palmMute + ", staccato=" + staccato
				+ ", tapping=" + tapping + ", slapping=" + slapping
				+ ", popping=" + popping + ", fadeIn=" + fadeIn + "]";
	}
