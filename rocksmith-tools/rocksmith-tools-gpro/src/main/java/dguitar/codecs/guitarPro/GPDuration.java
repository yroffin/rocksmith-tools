...
/**
 * This class describes a duration read from a Guitar Pro file. Please note
 * there is still an undocumented value used by this class.
 * 
 * @author Matthieu Wipliez
 * @see GPDuration#valueOf(int)
 */
public class GPDuration implements java.lang.Comparable<GPDuration> {
	/**
	 ...
	 */
	public int compareTo(GPDuration obj) {
		return (obj instanceof GPDuration) ? obj._type - _type : -1;
	}
	...
	public boolean equals(Object obj) {
		return (obj instanceof GPDuration) ? _type == ((GPDuration) obj)._type
				: false;
	}
	 ...
	 * 
	 * @return an index number, 0 for Whole note, 1 for half note... and so on
	 */
	public int getIndex() {
		return (_type + 2);
	}
	 ...
	 * 
	 * @return the number that was read from the stream that represents the
	 *         duration.
	 */
	public int getType() {
		return _type;
	...
	/**
	 * Returns the GPDuration associated with the value <code>type</code>.
	 * 
	 * @param type
