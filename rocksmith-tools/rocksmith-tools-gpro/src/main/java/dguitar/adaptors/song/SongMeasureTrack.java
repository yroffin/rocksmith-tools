...
/**
 * A collection of one or more SongVirtualTrack objects listing the events on a
 * given guitar string. Unstring instruments (such as piano or drums) list all
 * their events on a single virtual track.
 * 
 * @author Chris
 */
