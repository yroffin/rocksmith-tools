...
public interface SongMeasure extends SongPhrase {
	...
	/**
	 * Retrieves the SongMeasureTrack (list of SongEvents) for the given track
	 * in this measure.
	 * 
	 * @param track
	 *            the track for which to retrieve the measure data.
	 * @return the song measure track of the score of this measure on this
	 *         track.
	 */
