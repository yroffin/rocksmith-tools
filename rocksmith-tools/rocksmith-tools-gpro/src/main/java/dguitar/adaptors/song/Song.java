...
public interface Song extends SongPhraseList {
	...
	/**
	 * This is a convenience method to return the given measure from the score
	 * in musicians' notation (measure 1 is the first measure printed, not 0)
	 * 
	 * @see dguitar.adaptors.song#SongPhrase
	 * @param measure
