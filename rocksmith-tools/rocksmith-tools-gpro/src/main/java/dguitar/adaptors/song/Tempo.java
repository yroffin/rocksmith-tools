...
/**
 * A tempo is commonly expressed in two notations 'beats per minute' (which
 * requires definition of the size of a beat) 'microseconds per quarter note'
 * (which does not) This class handles the conversions between the two.
 * 
 * @author crnash
 */
public class Tempo {
	...
	public String toString() {
		return "Tempo [beat=" + beat + ", bpm=" + bpm + ", usq=" + usq + "]";
	}
}
