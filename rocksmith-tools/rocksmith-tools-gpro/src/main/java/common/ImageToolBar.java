...
public class ImageToolBar extends JToolBar implements Serializable,
	...
	/**
	 * Set the images of this ImageToolBar based on the images passed as
	 * parameter
	 * 
	 * @param images
	...
	/**
	 * Set the images of this ImageToolBar based on the imageIcons passed as
	 * parameter
	 * 
	 * @param imageIcons
	...
	/*
	 * public void setButtonStatus(int i, int status) { if ( validIndex(i) ) {
