 ...
 */
public class FileLoader implements LicenseString {
	...
	public FileLoader(String fileName) {
		...
		if ((file != null) && (file.isFile())) sizeLoader = this.lengthOfTask = (int) file
				.length();
		else errorCode = "FILE OBJECT COULD NOT BE CREATED";
	}
	...
	/**
	 * This is called to find out how much work needd to be done to complete the
	 * load.
	 */
	...
	/*
	 * try { FR = new FileReader(str) ; BR = new BufferedReader(FR) ; do { line
	 * = BR.readLine() ; if(line != null) { this.append(line + "\n") ;
	 * contLines++ ; } } while (line != null) ; } catch (Exception e) { success
